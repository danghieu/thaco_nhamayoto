...
namespace THACO
{
    public partial class Form1 : Form
    {
        ...
        int soCbbSp = 4;//Number of Combobox to show product
        public Form1()
        {
            InitializeComponent();
        ...
        public void loadData()
        {
            ...
            TB_KHN1.Text = "0"; TB_KHN2.Text = "0"; TB_KHN3.Text = "0"; TB_KHN4.Text = "0";  TB_TKHN.Text = "0";
            DatNgay();
        ...
        private void TIMER2_Tick(object sender, EventArgs e)
        {
               // checkConnectDatabase();
                ...
                {
                    setStatus(false, "DATABASE CONECTION FAILED");
                    return;
                }
        }
